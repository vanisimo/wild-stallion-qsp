...
### 0.3a Голос Мелиссы в зале / уговоре / missing (канон)

**Не** злая стервозная «проститутка».  
**Да** — книжная зазнайка **как Гермиона Грейнджер из «Гарри Поттера»** (типаж, не кроссовер): похоть клиентов = смешная, предсказуемая, наивная; закатывает глаза; ирония над эвфемизмами («бутончик»); торг с лёгкой усмешкой; серебро → **бумага / книги / стихи**.

Полный канон: `docs/design-npc-voices.md` §3.  
Эталон реплик: `modules/events/hall/hall_missing_bargain_text.qsps` (ветки Melissa).

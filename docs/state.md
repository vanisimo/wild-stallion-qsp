...
- **Play profiles + live-NTR + OffenseDays:** design + **code v1** (`1f77539`: offense_days, spark_queue, race live fixes, 4c texts). Dual protect **K=3**; ban immediate. Full design: `docs/design-character-intimacy-arc.md`. **QA:** `docs/qa-checklist-paths-offense-v1.md`. Handoff: `docs/session-handoff-2026-07-14.md`.
